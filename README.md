...
sequenceDiagram
    ...
    ⚡Backend->>⚡Backend: ⚖️Compute Technical Penalty
    ⚡Backend->>⚡Backend: 🧮Final Score + Explanation

    %% Parallel response and async task
    par Send Response
        ⚡Backend-->>🖥️Frontend: Return JSON (Score + Insights)
    ...
    🔧 AsyncJob->>🔧 AsyncJob: 🔬 Optuna Tuning
